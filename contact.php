					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> SSCCS <br/> Bhavnagar</address>
								</li>
								<li>
										<h5>Email</h5><a href="vaghanipriyank99@gmail.com">vaghanipriyank99@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 123456789">+91 1234567890</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : SSCCS,Bhavnagar</p>
								<p>Email : <a href="vaghanipriyank99@gmail.com">vaghanipriyank99@gmail.com</a></p>
